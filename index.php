...
Search : <input class="search-input form-control search"></input>
    <button onClick="open_all()" class="btn btn-primary btn-block btn-sm" id="open">open all</button>
    </input><button onClick="close_all()"class="btn btn-primary btn-block btn-sm" id="close" style="display:none">close all</button>
...
<form action='move_item.php' method='GET'>
	...
	<div class="rtext"><button type="submit" id="add_button" class="btn btn-primary btn-block btn-lg" <?php echo $val; ?> > Move Items</button></div>
    <br><br>
</form>
